...
def submit_flag():
    ...
    # Check if this is the first blood for this challenge
    first_submission_for_challenge = Submission.query.filter_by(chall_id=flag.chall_id).first()
    is_first_blood = first_submission_for_challenge is None
    ...
    # # Invalidate scoreboard cache when new submission is added
    # try:
    ...
    # Emit first blood event if this is the first submission for this challenge
    if is_first_blood:
        socketio.emit('firstblood', {
            'attacker': username,
    ...
    # Emit regular flag submission event
